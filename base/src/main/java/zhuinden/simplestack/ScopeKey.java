...
public interface ScopeKey {
     ...
     * <p>
     * If a {@link Child} is the top-most scope, then its explicit scopes are activated as well, so their services have {@link ScopedServices.Activated#onScopeActive(String)} called if they implement {@link ScopedServices.Activated}.
     */
